    ...
    edited = st.data_editor(
        ...
        column_config={
            ...
            "cantidad": st.column_config.NumberColumn(
                "cantidad", min_value=0.0, step=1.0, disabled=True
            ),
            "precio_unitario": st.column_config.NumberColumn(
                "precio_unitario", min_value=0.0, step=1.0, disabled=True
            ),
